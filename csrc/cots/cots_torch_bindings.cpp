...
PYBIND11_MODULE(_cots_C, m) {
  ...
  py::class_<CotsSuffixAttentionInfer>(m, "CotsSuffixAttentionInfer")
      ...
      .def("submit_prepared_on_stream",
           &CotsSuffixAttentionInfer::submit_prepared_on_stream,
           py::arg("task_id"), py::arg("cuda_stream"))
      .def("set_runtime_counts", &CotsSuffixAttentionInfer::set_runtime_counts,
           py::arg("num_tokens"), py::arg("scatter_count"))
      .def("sync_on_stream", &CotsSuffixAttentionInfer::sync_on_stream,
           py::arg("cuda_stream"))
      .def("sync_or_wait_on_stream",
           &CotsSuffixAttentionInfer::sync_or_wait_on_stream,
           py::arg("task_id"), py::arg("cuda_stream"))
      .def("install_wait_kernel_sync_for_task",
           &CotsSuffixAttentionInfer::install_wait_kernel_sync_for_task,
           py::arg("task_id"))
      .def("wait_kernel_sync_installed_for_task",
           &CotsSuffixAttentionInfer::wait_kernel_sync_installed_for_task,
           py::arg("task_id"))
      .def("wait_kernel_sync_on_stream",
           &CotsSuffixAttentionInfer::wait_kernel_sync_on_stream,
           py::arg("task_id"), py::arg("cuda_stream"))
      .def("wait_kernel_get_req_slot",
           &CotsSuffixAttentionInfer::wait_kernel_get_req_slot,
           py::arg("task_id"))
      .def("wait_kernel_get_done_slot",
           &CotsSuffixAttentionInfer::wait_kernel_get_done_slot,
           py::arg("task_id"))
      .def("wait_kernel_set_req_slot",
           &CotsSuffixAttentionInfer::wait_kernel_set_req_slot,
           py::arg("task_id"), py::arg("value"))
      .def("wait_kernel_set_done_slot",
           &CotsSuffixAttentionInfer::wait_kernel_set_done_slot,
           py::arg("task_id"), py::arg("value"))
      .def("sync_blocking", &CotsSuffixAttentionInfer::sync_blocking)
      .def("get_counters",
           [](const CotsSuffixAttentionInfer& self) {
             py::dict out;
      ...
      .def("reset_counters", &CotsSuffixAttentionInfer::reset_counters)
      .def("has_error", &CotsSuffixAttentionInfer::has_error)
      .def("take_error", &CotsSuffixAttentionInfer::take_error)
      .def("check_error", &CotsSuffixAttentionInfer::check_error);
