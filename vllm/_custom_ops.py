...
def cots_gqa_bf16_decode_attention(
    query: torch.Tensor,
    key_cache: torch.Tensor,
    value_cache: torch.Tensor,
    block_table: torch.Tensor,
    ...
    _cots_C.gqa_bf16_decode_attention(
        query,
        key_cache,
        value_cache,
        block_table,
...
def cots_gqa_bf16_prefill_attention(
    query: torch.Tensor,
    key_cache: torch.Tensor,
    value_cache: torch.Tensor,
    block_table: torch.Tensor,
    query_to_seq: torch.Tensor,
    seq_lens: torch.Tensor,
    scale: float,
    output: torch.Tensor,
    output_lse: torch.Tensor,
    ...
    _cots_C.gqa_bf16_prefill_attention(
        query,
        key_cache,
        value_cache,
        block_table,
